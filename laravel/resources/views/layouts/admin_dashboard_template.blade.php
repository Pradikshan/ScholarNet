        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="{{ asset('assets/dashboard/images/user.png') }}" alt="Profile image"> </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" src="{{ asset('assets/dashboard/images/user.png') }}" alt="Profile image" style="width: 200px;">
              ...
              <!-- <a class="dropdown-item"><i class="dropdown-item-icon mdi mdi-power text-primary me-2">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="user_management">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{ url('/admin_delete_user_account') }}">Manage user account</a></li>
